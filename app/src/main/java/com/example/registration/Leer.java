...
public class Leer extends AppCompatActivity {
    ...
    private Button b_volver,b_aggdirec;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b_aggdirec = findViewById(R.id.btnEdit);
        ...
        b_aggdirec.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View view) {
                Intent i = new Intent(getApplicationContext(), newDirecciones.class);
                startActivity(i);
            }
        });
