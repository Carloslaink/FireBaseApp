...
public class newDirecciones extends AppCompatActivity {

    private EditText ed_nombre;
    private EditText ed_apellido;
    private EditText ed_edad;
    private Button b_agregar,b_ver,b_volveralmapa;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.new_direc);
        ...
        b_volveralmapa =findViewById(R.id.btn_volveralmapa);
        b_agregar = findViewById(R.id.btn_agregarr);
        b_ver = findViewById(R.id.btn_verr);

        b_volveralmapa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v)
            {
                Intent i = new Intent(getApplicationContext(), MapboxActivity2.class);
                startActivity(i);
            }
        });
